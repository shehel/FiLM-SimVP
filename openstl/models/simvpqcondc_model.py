...
class SimVPQCondC_Model(nn.Module):
    r"""SimVP Model
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=384, N_S=4, N_T=4, model_type='gSTA',
        ...
        super(SimVPQCondC_Model, self).__init__()
        ...
        self.dec = Decoder(hid_S, C-1, N_S, spatio_kernel_dec, act_inplace=act_inplace)
    ...
    def forward(self, inputs):
        ...
        Y = rearrange(Y, '(B T) Q C H W -> B Q T C H W', B=B, T=T, Q=3, H=H, W=W, C=C-1)
