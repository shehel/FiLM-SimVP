...
class SimVPQFiLMC_Model(nn.Module):
    r"""SimVP Model
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=384, N_S=4, N_T=4, model_type='gSTA',
        ...
        super(SimVPQFiLMC_Model, self).__init__()
    ...
    def __init__(self, C_in, C_hid, N_S, spatio_kernel, act_inplace=True):
        ...
        self.enc = nn.Sequential(
              ConvSC(C_in, C_hid, spatio_kernel, downsampling=samplings[0],
                     act_inplace=act_inplace, filmed=False, independent_film=False),
            *[ConvSC(C_hid, C_hid, spatio_kernel, downsampling=s,
                     act_inplace=act_inplace, filmed=False, independent_film=True) for s in samplings[1:]]
        )
        ...
        self.dec = nn.Sequential(
            *[ConvSC(C_hid, C_hid, spatio_kernel, upsampling=s,
              ...
              ConvSC(C_hid, C_hid, spatio_kernel, upsampling=samplings[-1],
                     act_inplace=act_inplace, filmed=False, independent_film=True)
        )
    ...
    def __init__(self, in_channels, out_channels, input_resolution=None, model_type=None,
        ...
        if model_type == 'gsta':
            self.block = GASubBlock(
                ...
                drop=drop, drop_path=drop_path, act_layer=nn.GELU, filmed=filmed, independent_film=True)
